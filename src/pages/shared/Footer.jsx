...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-slate-200">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:pt-20">
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-3xl px-2'>
          Camp <span className='font-bold text-violet-600'>Ninja</span>
            ...
            <p className="mt-6 max-w-md text-center text-lg leading-relaxed text-gray-900 sm:max-w-xs sm:text-left">
              We care about your children. Connect with us at social media to see our activities.
            </p>
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <Link
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-violet-600 transition hover:text-teal-700/75"
                >
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <Link
                    className="group flex justify-start max-[600px]:justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                    to="/"
                  >
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-gray-700">
                    31 Avenue, Chattogram, Bangladesh
                  </address>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-500">
              ...
              <Link
                className="inline-block text-violet-600 underline transition hover:text-teal-600/75"
                to="/"
              >
                Terms & Conditions
              </Link>
    ...
    <div className="-mx-4 flex flex-wrap">
      <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
        <div className="mb-10 w-full">
          <Link to="javascript:void(0)" className="mb-6 inline-block max-w-[160px]">
            <img
