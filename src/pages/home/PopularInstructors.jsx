...
import useGetPopularInstructors from "../../hooks/useGetPopularInstructors";
import { Link } from "react-router-dom";
const PopularInstructors = () => {
  const [popularInstructors, refetch] = useGetPopularInstructors()
    ...
    //   ];
      return (
        <div className="max-w-[1300px] mx-auto py-10 mt-4">
          ...
          <p className="text-gray-500 dark:text-white text-base py-3 text-center w-[450px] max-sm:w-auto mx-auto">
            ...
            {popularInstructors.map((instructor, i) => {
              return (
                <div
                  ...
                  key={i}
                >
                  <img className="w-52 h-40 rounded-2xl" src={instructor.photoUrl} alt="services" />
                  <p className="text-xl mt-2 group-hover:text-white font-semibold line-clamp-1">
                      {instructor.name}
                    </p>
