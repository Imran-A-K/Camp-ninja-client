    ...
    {open && <span className="text-xl mt-3 whitespace-pre">Hi,{user?.displayName}</span>
          ...
          <div className="flex flex-col  h-full">
            <ul className="whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col gap-1  font-medium overflow-x-hidden scrollbar-thin scrollbar-track-white scrollbar-thumb-slate-100   md:h-[68%] h-[70%]">
              <li>
                <NavLink to={"/student-dashboard/my-selected-classes"} className="links">
                  <AiOutlineAppstore size={23} className="min-w-max" />
                  My Selected Classes
                </NavLink>
              </li>
              <li>
                <NavLink to={"/student-dashboard/my-enrolled-classes"} className="links">
              ...
              {(open || isTabletMid) && (
                <div className="border-t py-5 border-slate-300 ">
                  ...
                  <li>
                <NavLink to={"/student-dashboard/payment-history"} className="links">
